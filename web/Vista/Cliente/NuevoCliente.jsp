<%-- 
    ...
    Created on : Aug 6, 2020, 12:25:16 AM
    Author     : trece
--%>
...
<div class="container" id="">
    <div class="tenerOver">
        <form id="formNuevoClienteD">
            <input type="hidden" name="accion" value="AgregarClienteDts"/>
...
<script src="./Javascript/Cliente/NuevoCliente.js" type="text/javascript"></script>