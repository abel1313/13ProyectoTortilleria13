<%-- 
    Document   : EditarClienteExistente
    Created on : Aug 6, 2020, 11:55:38 PM
    Author     : trece
--%>
...
<%
    Cliente cl = new Consultas.ConsultaCliente().cli((Integer.parseInt(request.getParameter("idCli"))));
